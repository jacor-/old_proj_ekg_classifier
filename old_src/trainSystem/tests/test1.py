...
reload(chrClass)
from beatWork.characterization.caracteritzacioAlternativa import getCharacterization as chr_criteria
...
def test1(lead):
    ...
    tr = trainer("instancias_produccion/pfcCharC"+str(lead))
...
import cPickle
tr = trainer("instancias_produccion/pfcCharC1")
tr.Load()
